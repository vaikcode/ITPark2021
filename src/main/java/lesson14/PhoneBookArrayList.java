...
//    private int id;             // ID
//    private PhoneBookArray[] phoneBookArray = new PhoneBookArray[10];         // Телефонная книга в виде массива
//    private List<PhoneBookArray> phoneBookArrayList = new ArrayList<>(); // Телефонная книга в виде ArrayList
//
